...
class CatalogsService:
    ...
    async def create(self, catalog:CatalogDTO)->Result[str, OcaError]:
        ...
        Returns:
            Result[str,OcaError]: An 'Ok' wrapping the newly created Catalog ID (cid) if successful,
            or an 'Err' wrapping an OcaError if the insertion fails. 
        """
...
class ObservatoriesService:
    ...
    async def create(self,observatory:ObservatoryDTO)->Result[str,OcaError]:
        ...
        Returns:
            Result[str, OcaError]: An 'Ok' with the new obid if creation succeds, or
    ...
    async def update_catalogs(self, obid:str, catalogs: List[LevelCatalogDTO])->Result[str,OcaError]:
        ...
        Returns:
            Result[str,OcaError]: An 'Ok' containing the obid if the update is successful,
    ...
    async def find_by_obid(self, obid:str)->Result[ObservatoryDTO,OcaError]:
        ...
        Returns:
            Result[ObservatoryDTO, OcaError]: An 'Ok' containing the ObservatoryDTO if found, 
            or an 'Err' wrapping a NotFound error if it does not exist.
        """
...
class ProductsService:
    ...
    async def create_many(self, products:List[ProductDTO]=[])->Result[List[str], OcaError]:
        ...
        Returns:
            Result[List[str], OcaError]: An 'Ok' containing a list of the inserted product PIDs, 
    ...
    async def filter_by_levels(self,tags:List[str],levels:List[str],skip:int=0, limit:int=100)->Result[List[ObjectId], OcaError]:
        ...
        Returns:
            Result[List[ObjectId], OcaError]: An 'Ok' wrapping the ObjectIds of the matched products, 
    ...
    async def delete_by_pid(self, pid:str)->Result[str, OcaError]:
        ...
        Returns:
            Result[str, OcaError]: An 'Ok' with the deleted pid if successful, 
